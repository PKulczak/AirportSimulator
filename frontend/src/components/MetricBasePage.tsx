...
export default function MetricBasePage() {
  ...
  return (
    <div className="-m-6 h-[calc(100%+3rem)] flex flex-col">
      ...
      >
        <div className="queue-scroll relative flex max-h-full w-full max-w-5xl flex-col gap-3 overflow-y-auto rounded-lg border-2 border-black bg-white p-4 shadow-2xl sm:p-6">
